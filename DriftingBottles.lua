...
bottle_type = {"啤酒瓶","塑料瓶","玻璃瓶","牛奶瓶","娃哈哈AD钙奶瓶","威士忌酒瓶","伏特加酒瓶","莫洛托夫鸡尾酒瓶","可乐瓶","春药瓶","宠物小精灵瓶","化妆瓶","葡萄酒瓶","安眠药瓶","止咳糖浆瓶","五粮液瓶","江小白瓶","梦境增强剂瓶","克莱因瓶"}
...
function throw_bottle(msg)
	...
	if ( getUserToday(msg.fromQQ,"DB_everyday_throw",0)>= DB_everyday_max_throw ) then
		return "[CQ:at,qq="..msg.fromQQ.."]今天已经扔了太多漂流瓶啦！"
		else
		...
		if ( msg.fromGroup == "0" ) then
			letter_full = "[CQ:at,qq="..msg.fromQQ.."]在海边捡到了一个"..random_bottle.."，打开瓶子，里面有一张纸条，写着：\n"..letter.."\n【来自"..getUserConf(msg.fromQQ,"nick","某人").."("..msg.fromQQ..")悄悄留下的漂流瓶】c2xhc2g="
			else
		...
		return "[CQ:at,qq="..msg.fromQQ.."]将一个写着【"..letter.."】的纸条塞入瓶中扔进大海，希望有人捞到吧——"
	end
end
...
function bottle_num(msg)
	if ( getUserToday(msg.fromQQ,"DB_everyday_drown",0) >= DB_everyday_max_drown ) then
		...
		return "[CQ:at,qq="..msg.fromQQ.."]缓缓走入大海，感受着海浪轻柔地拍打着你的小腿，膝盖……\n波浪卷着你的腰腹，你感觉有些把握不住平衡了……\n……\n你沉入海中，".. #letter_list-1 .."个物体与你一同沉浮。\n不知何处涌来一股暗流，你失去了意识。"
	end
end
